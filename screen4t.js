...
d3.select("#tioutline").append("circle").attr("cx",150).attr("cy",150).attr("r",145).style("stroke-width","0px").style("stroke","#fff").style("stroke-opacity",1).style("fill","#7569CC").style("fill-opacity",1);
...
function updateTeamStats(dataset) {
	...
	d3.select("#marketvalue").text('\u20AC '+currTeamDetails.MarketValue + "Mn");
